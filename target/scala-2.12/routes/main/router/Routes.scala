...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """Managementroom""", """controllers.HomeController.MMM"""),
  ...
  // @LINE:10
  private[this] lazy val controllers_HomeController_MMM2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("Managementroom")))
  )
  private[this] lazy val controllers_HomeController_MMM2_invoker = createInvoker(
    HomeController_0.MMM,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "MMM",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_HomeController_MMM2_route(params@_) =>
      call { 
        controllers_HomeController_MMM2_invoker.call(HomeController_0.MMM)
      }
