...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """On""", """controllers.HomeController.on"""),
  ...
  // @LINE:11
  private[this] lazy val controllers_HomeController_on3_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("On")))
  )
  private[this] lazy val controllers_HomeController_on3_invoker = createInvoker(
    HomeController_0.on,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:11
    case controllers_HomeController_on3_route(params@_) =>
      call { 
        controllers_HomeController_on3_invoker.call(HomeController_0.on)
      }
